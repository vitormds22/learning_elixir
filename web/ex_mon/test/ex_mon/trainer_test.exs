defmodule ExMon.TrainerTest do
  ...
  describe "build/1" do
    test "when ther are valid params, returns a tupla with ok and trainer struct" do
      params = %{name: "Vitor", password: "123456"}
    ...
    test "when ther are invalid params, returns a tupla with error and changeset" do
      params = %{password: "123456"}
